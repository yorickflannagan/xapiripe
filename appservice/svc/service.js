...
const { Config, Message, WarnMessage, DelayedPromise } = require('./module');
const { Logger, LogLevel, sprintf } = require('wanhamou');
const { CORSBlockade, HTTPServer } = require('hekura');
...
process.on('message', (message) => {
	let logger = Logger.getLogger('Hekura Service App');
